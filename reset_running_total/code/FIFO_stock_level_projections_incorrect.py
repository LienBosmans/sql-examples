...
# Part 1: Calculate expired quantities 
...
running_total_expired_stock as (
    select
        *,
        case
...
expired_stock_transactions as (
    select 
        product_code,
        concat('WASTE ',reference_number) as reference_number,
...
duckdb.sql("select * from part1 where product_code = 'cupc01'").show()


# Part 2: Use expired quantities as "waste orders" to calculate accurate FIFO stock level projections
...
duckdb.sql("select * from part2 where product_code = 'cupc01'").show()
